...
> [!CAUTION]
> **TÀI LIỆU NỘI BỘ DÀNH CHO MENTOR (HƯỚNG DẪN ĐÁNH GIÁ):**
> Khi chấm bài Activity Diagram của học viên, Mentor cần kiểm tra các điểm Check-list sau:
> 1. Học viên có sử dụng đúng ký hiệu "Nút Bắt đầu" (Hình tròn đen) và "Nút Kết thúc" (Hình tròn có viền) không?
> 2. Có ít nhất **2 Nút rẽ nhánh (Decision - Hình thoi)**: Một nút cho việc "Kiểm tra Email tồn tại", và một nút cho việc "Kiểm tra OTP hợp lệ".
> 3. Các đường mũi tên thoát ra từ Nút hình thoi bắt buộc phải có nhãn (Label) ghi rõ điều kiện (VD: [Tồn tại], [Không tồn tại], [Hợp lệ], [Hết hạn]). Nếu học viên quên đánh nhãn, biểu đồ sẽ mất đi tính logic.
