...
2. [PHẦN II: QUẢN LÝ KÍP TRỰC & PHÂN CÔNG KHÁCH HÀNG PHỤ TRÁCH (CREW DEFINITION & CUSTOMER ASSIGNMENT)](#phan-ii-quan-ly-kip-truc--phan-cong-khach-hang-phu-trach-crew-definition--customer-assignment)
...
# PHẦN II: QUẢN LÝ KÍP TRỰC & PHÂN CÔNG KHÁCH HÀNG PHỤ TRÁCH (CREW DEFINITION & CUSTOMER ASSIGNMENT)

# ĐẶC TẢ YÊU CẦU PHẦN MỀM (SRS)
## TÍNH NĂNG: QUẢN LÝ KÍP TRỰC & PHÂN CÔNG KHÁCH HÀNG PHỤ TRÁCH (CREW DEFINITION & CUSTOMER ASSIGNMENT MANAGEMENT)
...
| **Tên chức năng** | Quản lý Kíp trực & Phân công Khách hàng phụ trách (Crew Definition & Customer Assignment Management) |
| **Mô tả tổng quan** | Tính năng này cho phép Quản lý SOC (SOC Manager) và Quản trị viên hệ thống tổ chức đội ngũ kỹ sư an ninh thành các Kíp làm việc tác chiến cố định (như Kíp 1, Kíp 2, Kíp Alpha...); chỉ định nhân sự giữ vai trò Trưởng kíp (Crew Lead / Shift Lead); và cấu hình tập trung Phân công Khách hàng phụ trách (Customer Assignment) cho từng thành viên trong kíp từ danh mục khách hàng do phòng ban quản lý. Đặc biệt, mỗi kíp trực khi tạo lập được gắn với một **Phòng ban phụ trách** cụ thể trong hệ thống SOC (ví dụ: *Ban NCS*, *SOC Khối Tài chính - Ngân hàng*...). Khi có sự việc (Case) phát sinh từ khách hàng, Case sẽ được xác định thuộc khách hàng nào và do phòng ban phụ trách khách hàng đó xử lý. Do đó, Trưởng kíp và các thành viên kíp bắt buộc phải thuộc cùng phòng ban để đảm bảo thẩm quyền và sự am hiểu nghiệp vụ khách hàng. Trong kíp trực, cho phép 1 nhân viên phụ trách nhiều khách hàng (1-N) và nhiều nhân viên cùng trực 1 khách hàng (N-1). Khi lưu cấu hình kíp trực, hệ thống bắt buộc kiểm tra độ phủ 100% khách hàng của phòng ban (không cho phép bỏ sót bất kỳ khách hàng nào chưa có nhân sự trực). Khi có sự việc (Case) phát sinh từ khách hàng, Case sẽ được phân bổ chính xác cho kỹ sư đang trực ca phụ trách khách hàng đó theo thuật toán điều phối (Xoay vòng đều hoặc Cân bằng tải) một cách minh bạch mà không cần cấu hình ma trận phân công phức tạp, rời rạc trên từng Correlation Rule đơn lẻ. Đồng thời, tính năng kiểm soát an toàn dữ liệu khi có biến động nhân sự (xóa thành viên khỏi kíp) và ngăn chặn xóa các kíp đang có lịch trực phân công. |
| **Phạm vi tính năng** | - **Bao gồm:**<br>&nbsp;&nbsp;+ Xem danh sách các Kíp trực với đầy đủ thông tin: Mã kíp, Tên kíp, Phòng ban phụ trách, Trưởng kíp, Số lượng thành viên, Tóm tắt phân công khách hàng, Trạng thái (Active/Inactive), Ngày tạo.<br>&nbsp;&nbsp;+ Bộ lọc kíp trực theo Phòng ban phụ trách khách hàng và trạng thái hoạt động.<br>&nbsp;&nbsp;+ Tạo mới / Cập nhật kíp trực với trường thông tin bắt buộc Phòng ban phụ trách, tự động ràng buộc Trưởng kíp và thành viên phải thuộc cùng phòng ban.<br>&nbsp;&nbsp;+ Tìm kiếm theo Tên/Mã kíp và Lọc theo Trạng thái hoạt động.<br>&nbsp;&nbsp;+ Thêm mới Kíp trực: Đặt tên, sinh mã, chỉ định Trưởng kíp, chọn danh sách thành viên và thiết lập Phân công Khách hàng phụ trách cho từng nhân sự (kèm tùy chọn tiện ích 'Tất cả khách hàng', ràng buộc phủ 100% khách hàng của phòng ban).<br>&nbsp;&nbsp;+ Cập nhật Kíp trực: Thay đổi Trưởng kíp, thêm/bớt thành viên, điều chỉnh phân công khách hàng và thuật toán điều phối (Xoay vòng đều hoặc Cân bằng tải). Khóa trường Mã kíp khi cập nhật.<br>&nbsp;&nbsp;+ Bật/Tắt nhanh trạng thái hoạt động (Active/Inactive) của Kíp trực.<br>&nbsp;&nbsp;+ Xóa Kíp trực kèm cơ chế kiểm tra ràng buộc toàn vẹn dữ liệu (chặn xóa nếu kíp đang có lịch trực hiện tại hoặc tương lai).<br>&nbsp;&nbsp;+ Cơ chế an toàn khi gỡ thành viên khỏi kíp: Giữ nguyên lịch trực hiệu lực của các đơn chuyển ca đã duyệt (ràng buộc trực tiếp User ID), tự động hủy bỏ các đơn chuyển ca đang ở trạng thái Chờ duyệt (`Pending`) liên quan đến nhân sự bị gỡ.<br>&nbsp;&nbsp;+ Ghi nhận nhật ký kiểm toán (Audit Log) cho toàn bộ các thao tác Thêm, Sửa, Xóa, Bật/Tắt kíp trực.<br>- **Không bao gồm:**<br>&nbsp;&nbsp;+ Phân bổ kíp vào các ngày cụ thể trên Lịch trực (thuộc tính năng Quản lý Lịch phân công `SOAR_ROSTER_SCHED_03`).<br>&nbsp;&nbsp;+ Tạo và phê duyệt đơn xin đổi ca/trực hộ giữa các cá nhân (thuộc tính năng Quản lý Đơn chuyển ca `SOAR_SHIFT_TRANSFER_04`). |
| **Điều kiện trước** | 1. Người dùng đã đăng nhập thành công vào hệ thống SOAR với tài khoản có thẩm quyền Quản lý SOC hoặc Super Admin.<br>2. Danh sách tài khoản người dùng thuộc đội ngũ SOC đã được khởi tạo và đang ở trạng thái hoạt động (`Active`).<br>3. Hệ thống đã thiết lập sẵn danh mục Khách hàng gắn theo từng Phòng ban phụ trách. |
| **Điều kiện sau** | 1. **Khi thêm mới thành công:** Bản ghi Kíp trực mới cùng cấu hình phân công khách hàng phụ trách được lưu vào CSDL, hiển thị trên bảng danh sách, sẵn sàng để phân bổ trên Lịch trực Roster; ghi nhận Audit Log.<br>2. **Khi cập nhật thành công:** Thông tin kíp và phân công khách hàng được cập nhật; thuật toán gán Case tự động sẽ áp dụng ngay danh sách nhân sự mới cho các Case phát sinh từ các khách hàng tương ứng; ghi nhận Audit Log.<br>3. **Khi xóa thành công:** Kíp trực bị xóa mềm (`is_deleted = true`), ghi nhận Audit Log.<br>4. **Khi gỡ thành viên khỏi kíp:** Các đơn chuyển ca Pending liên quan bị hủy; hệ thống gửi thông báo cho các bên liên quan; lịch hiệu lực của các ca đã duyệt giữ nguyên. |
...
Tính năng Quản lý Kíp trực & Phân công Khách hàng phụ trách được kiểm soát truy cập và phân định phạm vi thao tác dữ liệu theo cơ chế phân quyền chức năng:

### 2.1. Danh mục quyền chức năng

| Mã quyền | Tên quyền | Mô tả chi tiết |
| :--- | :--- | :--- |
| `CREW_VIEW` | **Xem** | Quyền xem danh sách các kíp trực, thông tin trưởng kíp, danh sách thành viên trong kíp, cấu hình phân công khách hàng phụ trách và trạng thái hoạt động. |
| `CREW_MANAGE` | **Tạo/sửa/xóa** | Quyền toàn quyền cấu hình kíp trực: Tạo kíp trực mới, Chỉnh sửa thông tin kíp trực / phân công trưởng kíp / thành viên / phân công khách hàng phụ trách, Xóa kíp trực và Bật/Tắt trạng thái hoạt động (Active/Inactive). *(Quyền này đã bao gồm quyền Xem).* |
...
3. Công tắc chuyển đổi **Active/Inactive** trên bảng dữ liệu chỉ mở quyền click tương tác cho tài khoản có quyền **Tạo/sửa/xóa**. Với tài khoản chỉ có quyền **Xem**, trạng thái hiển thị dưới dạng Badge tĩnh (chế độ Read-only).
4. Mọi hành động Tạo mới, Chỉnh sửa thông tin/thành viên/phân công khách hàng, Xóa hoặc Thay đổi trạng thái kíp trực từ người dùng có quyền `CREW_MANAGE` đều được hệ thống ghi nhận đầy đủ vào Nhật ký kiểm toán (Audit Log) theo [BR-06].
...
sequenceDiagram
    ...
    alt Dữ liệu Form không hợp lệ
        ...
        alt Mã kíp đã tồn tại
            ...
            BE->>DB: INSERT/UPDATE bảng phân công khách hàng `soar_crew_customer_assignments` [BR-03]
...
1. **Bước 1-8 (Khởi tạo form & Cấu hình):** Quản lý SOC bấm "+ Tạo kíp trực mới" hoặc "Sửa kíp". Frontend gọi API lấy danh mục nhân sự SOC đang hoạt động thuộc phòng ban phụ trách để nạp vào các Dropdown. Khi Quản lý chọn một nhân sự làm Trưởng kíp, Frontend tự động thêm nhân sự này vào danh sách Thành viên kíp nếu chưa có (`[BR-02]`). Quản lý tiếp tục cấu hình Phân công khách hàng phụ trách cho từng thành viên trong kíp và chọn thuật toán phân bổ nội bộ.
2. **Bước 9-13 (Validate Form tại Client):** Quản lý bấm "Lưu". Frontend kiểm tra các điều kiện bắt buộc: Tên kíp không được rỗng, Phòng ban phụ trách bắt buộc chọn, Mã kíp đúng định dạng in hoa không dấu, Số lượng thành viên tối thiểu 1 người, và kiểm tra độ phủ khách hàng 100% (toàn bộ khách hàng của phòng ban phải có ít nhất 1 kỹ sư phụ trách). Nếu có lỗi hoặc còn khách hàng chưa có người trực, hiển thị inline error message màu đỏ, toast cảnh báo và chặn thao tác lưu.
3. **Bước 14-22 (Backend kiểm tra trùng mã & Xử lý biến động thành viên):**
   ...
   - Lưu thông tin kíp vào bảng `soar_shift_crews`, lưu phân công khách hàng vào `soar_crew_customer_assignments` (`[BR-03]`) và ghi nhật ký kiểm toán vào `soar_audit_logs` (`[BR-06]`).
...
| STT | Tên trường | Loại dữ liệu | Mô tả |
| :---: | :--- | :--- | :--- |
| 1 | **Tiêu đề trang** | Label | - Tiêu đề màn hình, hiển thị tên phân hệ Quản lý Kíp trực.<br>- **Nội dung hiển thị mặc định:** `"Quản lý Kíp trực & Phân công Khách hàng"` (`"Crew & Customer Assignment Management"`)<br>- **Tính chất hiển thị:** Tĩnh (Static). |
| 2 | **Mô tả phụ** | Label | - Đoạn văn bản ngắn hướng dẫn vai trò của kíp trực và phân công khách hàng tiếp nhận Case.<br>- **Nội dung hiển thị mặc định:** `"Thiết lập các nhóm tác chiến cố định theo từng phòng ban, chỉ định Trưởng kíp và phân công khách hàng phụ trách tiếp nhận Sự việc cho từng kỹ sư trong kíp."`<br>- **Tính chất hiển thị:** Tĩnh. |
...
| 6 | **Thành viên trong kíp** | Multi-select Tag | - Người dùng chọn danh sách các nhân sự SOC tham gia làm việc trong kíp.<br>- **Định dạng hiển thị của mỗi thẻ tag:** Hiển thị thông tin dạng `username (Họ và tên)`, không hiển thị avatar tròn (ví dụ: `hoangnv1 (Nguyễn Văn Hoàng)`). Kèm icon "x" để gỡ thành viên.<br>- *Lưu ý giao diện:* Đã bỏ nút "Chọn tất cả" và nút "Chỉ giữ trưởng kíp".<br>- **Nguồn dữ liệu:** Danh sách nhân sự SOC thuộc đúng Phòng ban phụ trách đã chọn ở trường 3.1.<br>- **Quy tắc Nghiệp vụ & Ràng buộc:**<br>&nbsp;&nbsp;1. Bắt buộc có tối thiểu **01 thành viên** trong kíp.<br>&nbsp;&nbsp;2. Không cho phép xóa Trưởng kíp khỏi danh sách thành viên (icon "x" của Trưởng kíp bị ẩn).<br>&nbsp;&nbsp;3. Danh sách thành viên được chọn ở đây là nguồn nhân sự tham gia phân công khách hàng phụ trách.<br>- **Thông báo lỗi tương ứng:** Không có thành viên nào: Hiển thị lỗi inline: `"Kíp trực phải có ít nhất 01 thành viên!"` |
| **PHÂN CÔNG KHÁCH HÀNG PHỤ TRÁCH (CUSTOMER ASSIGNMENT)** | | | |
| 7 | **Khách hàng phân công cho từng thành viên** | Multi-select / Tag Grid | - Cấu hình danh sách khách hàng mà từng nhân viên trong kíp trực chịu trách nhiệm tiếp nhận và xử lý sự việc (Case).<br>- **Nguồn dữ liệu:** Danh mục tất cả Khách hàng do Phòng ban phụ trách đã chọn quản lý.<br>- **Mô hình phân công:**<br>&nbsp;&nbsp;+ Một nhân viên có thể phụ trách nhiều khách hàng (mối quan hệ 1-N).<br>&nbsp;&nbsp;+ Nhiều nhân viên có thể cùng trực chung một khách hàng (mối quan hệ N-1). Khi có sự việc phát sinh từ khách hàng này, Case sẽ được phân bổ tự động giữa các nhân viên cùng phụ trách theo thuật toán ở trường 9.<br>- **Tùy chọn tiện ích:** Checkbox `"[x] Tất cả khách hàng"` giúp gán nhanh toàn bộ khách hàng của phòng ban cho nhân sự đó. |
| 8 | **Ràng buộc Độ phủ Khách hàng bắt buộc (100% Coverage Validation)** | Validation Bar & Rule | - **Yêu cầu bắt buộc:** 100% khách hàng thuộc phòng ban phụ trách phải có ít nhất 01 nhân sự trong kíp trực đảm nhiệm.<br>- **Cơ chế kiểm tra:** Hệ thống tính toán hợp của tất cả khách hàng đã được gán cho các thành viên. Nếu còn bất kỳ khách hàng nào chưa có ai phụ trách:<br>&nbsp;&nbsp;+ Hiển thị cảnh báo inline màu đỏ liệt kê danh sách khách hàng còn thiếu.<br>&nbsp;&nbsp;+ **Chặn nút Lưu (Block Save):** Không cho phép lưu kíp trực khi độ phủ chưa đạt 100%.<br>&nbsp;&nbsp;+ Hiển thị Toast thông báo lỗi: `"Chưa phân công đủ khách hàng! Vui lòng phân công ít nhất 1 kỹ sư phụ trách cho mỗi khách hàng."` |
| 9 | **Thuật toán điều phối sự việc tự động** | Radio Button | - Nhãn hiển thị: `"Thuật toán điều phối sự việc:"`<br>- Áp dụng điều phối tự động khi có Case mới phát sinh từ một khách hàng có nhiều kỹ sư cùng phụ trách trong ca trực.<br>- **Danh sách tùy chọn:**<br>&nbsp;&nbsp;+ Tùy chọn 1: `"Xoay vòng đều"` (Giá trị: `ROUND_ROBIN` - Mặc định).<br>&nbsp;&nbsp;+ Tùy chọn 2: `"Cân bằng tải"` (Giá trị: `LEAST_LOAD` - Tự động gán cho nhân sự đang có ít Case mở nhất trong số các kỹ sư phụ trách khách hàng đó).<br>- **Quy tắc Nghiệp vụ:** Xem chi tiết thuật toán tại `[BR-03]`. |
| **NÚT BẤM HÀNH ĐỘNG** | | | |
| 10 | **Nút "Hủy bỏ" (Cancel)** | Button | - Cho phép người dùng đóng Modal và hủy bỏ thao tác.<br>- **Trạng thái mặc định:** Enabled.<br>- **Hành vi khi nhấn (OnClick):** Nếu form đã có chỉnh sửa dữ liệu, hiển thị Hộp thoại cảnh báo dữ liệu chưa lưu (Xem mục 4.3). Nếu chưa chỉnh sửa, đóng Modal ngay. |
| 11 | **Nút "Lưu" (Save)** | Button | - Nhãn nút hiển thị: `"Lưu"`.<br>- Cho phép người dùng gửi thông tin để lưu kíp trực vào hệ thống.<br>- **Trạng thái mặc định:** Enabled.<br>- **Quyền hạn truy cập:** Chỉ vai trò *Super Admin* và *SOC Manager*.<br>- **Hành vi khi nhấn (OnClick):**<br>&nbsp;&nbsp;1. Kiểm tra tính hợp lệ toàn bộ các trường trên form, đặc biệt kiểm tra độ phủ 100% khách hàng theo trường 8.<br>&nbsp;&nbsp;2. Nếu hợp lệ: Gửi payload lên Backend để lưu bản ghi kíp trực và phân công khách hàng phụ trách.<br>&nbsp;&nbsp;3. Nếu thành công: Đóng Modal, làm mới danh sách kíp trực, hiển thị Toast: `"Lưu kíp trực thành công!"`.<br>&nbsp;&nbsp;4. Nếu còn khách hàng chưa phân công: Chặn lưu, cuộn đến phần cảnh báo và hiển thị Toast lỗi. |
...
- **Trường hợp 1: Chưa có kíp trực nào trong hệ thống:**
  ...
  - Mô tả phụ: `"Tổ chức đội ngũ kỹ sư SOC thành các kíp trực cố định theo từng phòng ban và phân công khách hàng phụ trách tiếp nhận Case để tối ưu hóa vận hành."`
...
| **[BR-03]** | Phân công Khách hàng phụ trách và Thuật toán điều phối sự việc tự động | Thuật toán & Phân công | Bắt buộc |
...
### [BR-03] Phân công Khách hàng phụ trách và Thuật toán điều phối sự việc tự động (Customer Assignment & Auto-Dispatch Algorithm)
...
- **Điều kiện kích hoạt:** Khi một Case mới được tạo tại thời điểm $T$ từ Khách hàng $C$ và xác định được Kíp $K$ thuộc Phòng ban phụ trách khách hàng $C$ đang trong ca trực hiệu lực.
- **Logic xử lý chi tiết:**
  1. **Nguyên tắc phân công Khách hàng trong Kíp trực:**
     - Danh sách khách hàng hiển thị để phân công lấy theo danh mục Khách hàng do Phòng ban của kíp trực phụ trách quản lý.
     - Cho phép một nhân viên phụ trách nhiều khách hàng (mối quan hệ 1-N).
     - Cho phép nhiều nhân viên cùng tham gia trực và tiếp nhận Case của một khách hàng (mối quan hệ N-1).
     - Cung cấp tùy chọn nhanh *"Tất cả khách hàng"* để gán toàn bộ khách hàng của phòng ban cho nhân sự được chọn.
  2. **Ràng buộc kiểm tra Độ phủ Khách hàng bắt buộc (100% Customer Coverage Validation):**
     - Khi người dùng bấm **Lưu kíp trực**, hệ thống tự động kiểm tra tập hợp tất cả các khách hàng đã được gán cho các thành viên:
       $$C_{\text{assigned}} = \bigcup_{u \in \text{Members}} \text{Customers}(u)$$
     - **Điều kiện hợp lệ:** Bắt buộc độ phủ phải đạt 100% ($C_{\text{assigned}} = C_{\text{department}}$), nghĩa là mọi khách hàng của phòng ban đều phải có ít nhất 01 kỹ sư phụ trách.
     - **Hành vi khi vi phạm:** Nếu tồn tại bất kỳ khách hàng nào chưa có ai phụ trách ($C_{\text{department}} \setminus C_{\text{assigned}} \neq \emptyset$):
       * Hệ thống **chặn thao tác lưu (Block Save)**.
       * Hiển thị thông báo lỗi inline màu đỏ và Toast cảnh báo chi tiết liệt kê danh sách các khách hàng chưa được phân công:
         > *"Chưa phân công đủ khách hàng! Các khách hàng sau chưa có người trực: [Danh sách khách hàng]. Vui lòng phân công ít nhất 1 kỹ sư phụ trách trước khi lưu."*
  3. **Thuật toán điều phối tự động khi có Case phát sinh:**
     - Khi phát sinh Case mới từ Khách hàng $C$, hệ thống xác định danh sách các kỹ sư trong ca trực đang phụ trách khách hàng $C$: $S = \{U_1, U_2, ..., U_m\}$.
     - Nếu $m = 1$: Gán trực tiếp Case cho kỹ sư duy nhất phụ trách khách hàng đó.
     - Nếu $m > 1$ (nhiều kỹ sư cùng trực khách hàng $C$), hệ thống áp dụng Thuật toán điều phối nội bộ theo cấu hình của kíp:
       * **Chế độ 1: Xoay vòng đều (Round Robin):**
         Lấy con trỏ xoay vòng gần nhất của khách hàng $C$ trong kíp ($last\_assigned\_index$). Gán Case cho nhân sự tiếp theo: $U_{(last\_assigned\_index + 1) \pmod m}$. Cập nhật lại con trỏ xoay vòng trong Redis cache.
       * **Chế độ 2: Cân bằng tải (Least Load):**
         Đếm số lượng Case đang ở trạng thái chưa đóng (`New`, `Processing`) của từng nhân sự trong danh sách $S$. Gán Case cho kỹ sư có số lượng Case đang mở ít nhất:
         $$\text{Assignee} = \arg\min_{u \in S} (\text{OpenCases}(u))$$
         Nếu có nhiều kỹ sư có số Case mở bằng nhau, ưu tiên người có thời điểm nhận Case gần nhất xa nhất (Least Recently Assigned).
...
### [BR-06] Quy chuẩn ghi nhận Nhật ký kiểm toán (Audit Logging)
- **Phân loại:** Bảo mật & Lưu trữ
- **Phạm vi áp dụng:** Mọi hành động Thêm mới, Cập nhật, Xóa, Bật/Tắt kíp trực và thay đổi phân công khách hàng phụ trách.
- **Điều kiện kích hoạt:** Sau khi transaction CSDL của thao tác thực hiện thành công.
- **Logic xử lý chi tiết:**
  1. Hệ thống tự động ghi nhận một bản ghi vào bảng `soar_audit_logs` với các thông số:
     ...
     - `actor_ip`: Địa chỉ IP của client gửi request.
     - `old_values`: JSON lưu trạng thái kíp, danh sách thành viên và phân công khách hàng trước khi sửa.
     - `new_values`: JSON lưu trạng thái kíp, danh sách thành viên và phân công khách hàng sau khi sửa.
     - `timestamp`: Thời gian thực hiện (UTC timestamp).
...
| 3.1 | **Thanh trạng thái Độ phủ Khách hàng** | Progress / Alert Bar | - Hiển thị ngay trên bảng kỹ sư trực ca: `"Độ phủ: X/Y khách hàng"`.<br>- Nếu $X = Y$ (độ phủ 100%): Hiển thị Badge Xanh `"Đã phủ 100% khách hàng"`.<br>- Nếu $X < Y$ (còn khách hàng chưa có người trực): Hiển thị Cảnh báo vi phạm màu đỏ kèm thông báo lỗi: `"⚠️ Cảnh báo: Còn [Z] khách hàng chưa có kỹ sư phụ trách trong ca này!"` |
| 4 | **Bảng danh sách Kỹ sư trực thực tế** | Datatable | - Bảng hiển thị danh sách nhân sự tham gia ca trực này theo Lịch hiệu lực:<br>&nbsp;&nbsp;• Cột Họ tên kỹ sư & Email.<br>&nbsp;&nbsp;• Cột Khách hàng phụ trách (Customer Assignment): Hiển thị danh sách các thẻ Tag khách hàng mà kỹ sư phụ trách trực (hoặc `"Tất cả khách hàng (N khách)"`), kèm dropdown/multiselect cho phép điều chỉnh phân công trực tiếp trong ca.<br>&nbsp;&nbsp;• Cột Trạng thái trực: Badge Xanh `"Trực chuẩn"`, Badge Cam `"Trực thay cho [Tên kỹ sư A]"` (kế thừa phân công khách hàng của kỹ sư A), hoặc Badge Xanh lá `"Nhân sự tăng cường"`. |
...
| 6 | **Nút "Lưu thay đổi"** | Button | - Kiểm tra điều kiện bắt buộc độ phủ 100% khách hàng của phòng ban. Nếu có bất kỳ khách hàng nào chưa được phân công trong ca, hệ thống **CHẶN LƯU (Block Save)**, hiển thị Toast cảnh báo lỗi chi tiết liệt kê danh sách khách hàng còn thiếu.<br>- Khi độ phủ đạt 100%: Lưu lại các điều chỉnh gán kíp, phân công khách hàng hoặc nhân sự tăng cường vào CSDL; cập nhật ngay Lịch hiệu lực `[BR-02]`. |
...
| 4 | **Popover Chi tiết Ca cá nhân** | Popover | - Khi click vào một thẻ ca trực chuẩn (màu xanh dương), hiển thị Popover chứa:<br>&nbsp;&nbsp;• Giờ bắt đầu, Giờ kết thúc, Thời lượng ca.<br>&nbsp;&nbsp;• Danh sách đồng đội cùng trực trong kíp.<br>&nbsp;&nbsp;• Khách hàng phụ trách tiếp nhận xử lý trong ca (hoặc "Tất cả khách hàng (N khách)").<br>&nbsp;&nbsp;• **Nút tắt nổi bật: "Đề nghị đồng nghiệp trực hộ"** (Click mở modal "Đề nghị đồng nghiệp trực hộ"). |
...
| :---: | :--- | :--- |
| 1 | **Trạng thái phân công mặc định** | Khi có sự việc (Case) phát sinh trong ca trực chưa được phân bổ kíp hoặc không tìm được kỹ sư phụ trách khách hàng đó, hệ thống **mặc định để trống người xử lý** (`assignee_id = null`, `UNASSIGNED`). |
...
- **Logic xử lý chi tiết:**
  ...
  2. **Bước 2: Áp dụng các Đơn chuyển ca ĐÃ ĐƯỢC DUYỆT (`Approved Transfers`):**
     ...
     - Kỹ sư B kế thừa vai trò và danh sách Khách hàng phụ trách tiếp nhận của Kỹ sư A trong ca trực đó.
...
3. **Bước 19-27 (Phê duyệt và Cập nhật Lịch hiệu lực):**
   ...
   - Kể từ thời điểm này, mọi Case phát sinh từ các khách hàng mà Kỹ sư A phụ trách trong ca đó sẽ được Engine tự động gán cho Kỹ sư B theo phân công khách hàng. Lịch cá nhân của A tự động chuyển sang màu xám gạch ngang; Lịch cá nhân của B hiển thị ca trực thay màu xanh lá cây.
...
- **Logic xử lý chi tiết:**
  1. **Khóa trực tiếp vào User ID:** Đơn chuyển ca sau khi được phê duyệt sẽ khóa trực tiếp vào `user_id` của Kỹ sư B trên Lịch trực hiệu lực (`soar_effective_schedules`):
     ...
     ```
  2. **Kế thừa quyền và trách nhiệm:** Kỹ sư B hoàn toàn kế thừa vai trò và danh sách Khách hàng phụ trách tiếp nhận Case của Kỹ sư A trong ca trực đó.
