...
srs_path = r"E:\work1\EDR\SRS_Quan_Ly_IOC_EDR.md"

content = r"""# TÀI LIỆU ĐẶC TẢ YÊU CẦU NGHIỆP VỤ & HỆ THỐNG (BRD & SRS)
...
print("SRS_Quan_Ly_IOC_EDR.md updated successfully.")
